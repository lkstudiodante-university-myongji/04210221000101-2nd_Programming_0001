...
oPath_Resources = f"{oPath_Dir}/../../../Resources/Practice_12/P01MainWindow_12.ui"

# Practice 12
class CP01Practice_12(QMainWindow, uic.loadUiType(oPath_Resources)[0]):
	# 생성자
	def __init__(self):
		# 멤버 변수를 설정한다
		self.m_oCircleList = []
			...
			for oCircle in self.m_oCircleList:
				...
				if oCircle.GetRadius() <= 10.0:
					...
					for i in range(0, 2):
						...
						oSubCircle = CP01Circle_12(max(10.0, oCircle.GetRadius() / 2.0))
